@testset "Testing weight substitution" begin
    ...
    @info "Case 1"
    R, (x, y, z, a, b) = Nemo.polynomial_ring(Nemo.QQ, [:x, :y, :z, :a, :b])
    ...
    @info "Case 2"
    R, (x, y, z, a, b, c) = Nemo.polynomial_ring(Nemo.QQ, [:x, :y, :z, :a, :b, :c])
    ...
    @info "Case 3"
    R, (x, y, z) = Nemo.polynomial_ring(Nemo.QQ, [:x, :y, :z, :a, :b])
