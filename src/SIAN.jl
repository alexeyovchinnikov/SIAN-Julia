...
function identifiability_ode_2(ode, params_to_assess; p = 0.99, p_mod = 0, nthrds = 1, infolevel = 0)
    ...
    # (b,c) -------------
    X, X_eq = get_x_eq(x_eqs, y_eqs, n, m, u, gens_Rjet)

    # (d,e) -----------
    Y, Y_eq = get_y_eq(x_eqs, y_eqs, n, m, u, gens_Rjet)
